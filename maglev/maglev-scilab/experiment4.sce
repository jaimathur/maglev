...
global k_edit
k_edit=uicontrol(f,'unit','normalized','BackgroundColor',[-1,-1,-1],'Enable','on','FontAngle','normal','FontName','Tahoma','FontSize',[12],'FontUnits','points','FontWeight','normal','ForegroundColor',[-1,-1,-1],'HorizontalAlignment','left','ListboxTop',[],'Max',[1],'Min',[0],'Position',[0.4,0.0645833,0.1026393,0.0395833],'Relief','default','SliderStep',[0.01,0.1],'String','-1','Style','edit','Value',[-1],'VerticalAlignment','middle','Visible','on','Tag','lower_edit','Callback','update')
k=uicontrol(f,'unit','normalized','BackgroundColor',[-1,-1,-1],'Enable','on','FontAngle','normal','FontName','Tahoma','FontSize',[12],'FontUnits','points','FontWeight','normal','ForegroundColor',[-1,-1,-1],'HorizontalAlignment','left','ListboxTop',[],'Max',[1],'Min',[0],'Position',[0.4,0.0083333,0.2,0.0375],'Relief','default','SliderStep',[0.01,0.1],'String','Proportional gain','Style','text','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','lower','Callback','')
